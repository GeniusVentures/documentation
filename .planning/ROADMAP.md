...
- [ ] **Phase 8: LLM Document Graph** — [gendoc-template] Three-layer metadata system for RAG retrieval enrichment, evidence-backed LLM analysis pipeline, graph-based document relationships, incremental reanalysis (INSERTED)
